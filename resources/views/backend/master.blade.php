...
<head>
    ...
    <link href="{{ asset('helper.css') }}" rel="stylesheet">
</head>
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="{{asset('backend/build/images/admin.jpg')}}" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="{{asset('backend/build/images/admin.jpg')}}" alt="">John Doe
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <li>
                                    <a>
                                        <span class="image"><img src="{{asset('backend/build/images/admin.jpg')}}" alt="Profile Image" /></span>
                                        <span>
                          ...
                          <span class="time">3 mins ago</span>
                                        ...
                                        <span class="message">
                          Film festivals used to be do-or-die moments for movie makers. They were where...font
                        </span>
                                    </a>
                                </li>
                                <li>
